...
INSERT INTO `asuransi_aktif` (`id_premi`, `id_asuransi`, `id_pelanggan`, `siklus`) VALUES
...
INSERT INTO `pelanggan` (`id_pelanggan`, `nama`, `tanggal_lahir`, `jenis_kelamin`, `status`, `tanggal_masuk`, `gaji`) VALUES
...
ALTER TABLE `asuransi_aktif`
  ...
  ADD CONSTRAINT `asuransi_aktif_ibfk_2` FOREIGN KEY (`id_pelanggan`) REFERENCES `pelanggan` (`id_pelanggan`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
